...
const primaryColor = const Color(0xFF89F5FE);
const primaryLight = const Color(0xFF68ADFF);
const primaryDark = const Color(0xFF254784);
...
const Color gradientStart = const Color(0xFF68ADFF);
const Color gradientEnd = const Color(0xFF254784);
